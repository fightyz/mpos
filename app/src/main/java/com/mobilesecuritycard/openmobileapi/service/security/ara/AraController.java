...
public class AraController {
    ...
    protected ChannelAccess enableAccessConditions(ITerminal terminal, byte[] aid,
    	...
    	Log.d(ACCESS_CONTROLLER_TAG, "enableAccessConditions");
        ...
        try {
            ...
            Log.d(ACCESS_CONTROLLER_TAG, "[yz]channelAccess: " + channelAccess);
        } catch (Exception e) {
            String msg = e.toString();
...
//    	long hChannel = terminal.openBasicChannel(aid, callback);
    ...
    protected void closeChannel(IChannel channel) {
        ...
        } catch (com.mobilesecuritycard.openmobileapi.service.CardException e) {
        }
    }
