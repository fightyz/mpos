...
public class AccessRuleApplet {
    ...
    public boolean readAPLCertificate(ByteArrayOutputStream bytes, int offset, int length)
            throws AccessControlException, com.mobilesecuritycard.openmobileapi.service.CardException {
    ...
    public byte[] readAPKACRecord(byte[] hashApkCert) throws AccessControlException, com.mobilesecuritycard.openmobileapi.service.CardException {
    ...
    public boolean readACLRecordNFC(byte[] hashApkCert) throws com.mobilesecuritycard.openmobileapi.service.CardException {
        CommandApdu apdu = mReadACLRecord.clone();
        apdu.setP2(0x01);
        apdu.setData(hashApkCert);
        ResponseApdu response = send(apdu);
...
*/
    private ResponseApdu send(CommandApdu cmdApdu) throws com.mobilesecuritycard.openmobileapi.service.CardException {
